...
function Item({product}) {
    ...
    const {installment, priceWithDiscount, installmentWithDiscount, addProductCart} = useCartContext()
    const onAdd = (count) => {
        addProductCart(product, count);
    }
    return (
        <>
            <div className="col-lg-3 col-xs-12" data-aos="fade-up">
                <div className="card text-center mb-4">
                    ...
                    <div className="card-body">
                        ...
                        <p><b>6 </b>cuotas sin interés de <b>${product.discount > 0 ? installmentWithDiscount(product) : installment(product)}</b></p>
