        ...
        <main className="row">
            <section className="col-lg-12 col-xs-12">
                ...
                <div className="group-margin">
                    ...
                    <p className="mt-2">Actualmente somos una <b>empresa familiar</b> que se dedica a la venta minorista de los mejores <b>vinos de la región Cuyana</b></p>
                    <p className="mt-2">Deseamos que tengas <b>la mejor experiencia</b> con nosotros!</p>
                </div>
            </section>
        </main>
    )
